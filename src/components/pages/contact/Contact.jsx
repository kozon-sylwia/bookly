...
export const Contact = () => {
  ...
  return (
    <ContactBackground>
      <img src={message} alt={"logo"} width="300px" height="300px" />
      <StyledContainer>
        <StyledH2>
          If you have any <span className="orange__font">question</span>
          <br />
          send the <span className="orange__font">message</span>!
        </StyledH2>
